...
<div class="flex justify-center items-center min-h-screen ">
    <div class="md:w-4/5 text-center text-sm text-slate-600 p-5">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-24">
            ...
            <a href="{{ route('journal-papers.index') }}" class="flex flex-col justify-center items-center border p-2  hover:border-cyan-200 box-border">
            ...
            <a href="{{ route('conference-papers.index') }}" class="flex flex-col justify-center items-center border p-2  hover:border-green-200">
            ...
            <a href="{{ route('technical-reports.index') }}" class="flex flex-col justify-center items-center border p-2  hover:border-green-200">
                <div class="flex justify-center items-center bg-green-100 rounded-full w-12 h-12">
                    <i class="bx bx-world text-2xl text-green-400"></i>
                </div>
                <h3 class="mt-2 font-semibold text-base">Technical Report</h3>
            </a>
            <a href="{{ route('survey-reports.index') }}" class="flex flex-col justify-center items-center border p-2  hover:border-green-200">
                <div class="flex justify-center items-center bg-green-100 rounded-full w-12 h-12">
                    <i class="bx bx-world text-2xl text-green-400"></i>
                </div>
                <h3 class="mt-2 font-semibold text-base">Literature Survey Report</h3>
            </a>
            <a href="{{ route('review-papers.index') }}" class="flex flex-col justify-center items-center border p-2  hover:border-green-200">
                <div class="flex justify-center items-center bg-green-100 rounded-full w-12 h-12">
                    <i class="bx bx-cloud-snow text-2xl text-green-400"></i>
                </div>
                <h3 class="mt-2 font-semibold text-base">Reviewed Papers</h3>
            </a>
            <a href="{{ route('mphil.thesis') }}" class="flex flex-col justify-center items-center border p-2  hover:border-green-200">
                <div class="flex justify-center items-center bg-green-100 rounded-full w-12 h-12">
                    <i class="bx bx-bookmark-alt-plus text-2xl text-green-400"></i>
                </div>
                <h3 class="mt-2 font-semibold text-base">MPhil Thesis</h3>
            </a>
            <a href="{{ route('phd.thesis') }}" class="flex flex-col justify-center items-center border p-2  hover:border-green-200">
                <div class="flex justify-center items-center bg-green-100 rounded-full w-12 h-12">
                    <i class="bx bx-bookmark-alt-plus text-2xl text-green-400"></i>
                </div>
