...
<div class="responsive-container mt-32 w-4/5">
    ...
    <a href="{{ route('papers.create') }}" class="fixed right-12 bottom-12 w-12 h-12 rounded-full text-white text-2xl bg-teal-600 hover:bg-teal-800 flex justify-center items-center">+</a>
