...
<div class="mt-32 w-4/5 mx-auto border">
    ...
    <div class="container-light">
        <form action="{{route('conference-papers.store')}}" method='post' class="w-full md:w-2/3 mx-auto">
            @csrf
            ...
            <div class="grid gap-8 mt-6">
                ...
                <div class="">
                    ...
                    <input type="text" name='conference_name' class="custom-input-borderless" placeholder="conference name" value="" required>
                </div>
                <div class="">
                    <label>Location</label>
                    <input type="text" name='location' class="custom-input-borderless" placeholder="conference location" value="" required>
                </div>
                <div class="">
                    <label>DOI</label>
                ...
                <div class="">
                    ...
                    <input type="date" name='conference_date' class="custom-input-borderless" placeholder="Publication date" value="" required>
                </div>
